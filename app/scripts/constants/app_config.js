 ...
 */
 ...
 angular.module('canteenApp').constant('APP_CONFIG', {
 	...
 	reports_orders_cost_center_export: "/api/reports/ordersPerCostCenterExport",
 	reports_orders_next_week: "/api/reports/orderPlan",
 	reports_orders_next_week_export: "/api/reports/orderPlanExport",
 	reports_realized_ratio: "/api/reports/realizedUnrealized",
	reports_realized_ratio_export: "/api/reports/realizedUnrealizedExport",
 	reports_planned_unplanned: "/api/reports/plannedUnplanned",
 	reports_planned_unplanned_export: "/api/reports/plannedUnplannedExport",
 	...
 	reports_employees_plan_export: "/api/reports/employeesPlanningExport",
