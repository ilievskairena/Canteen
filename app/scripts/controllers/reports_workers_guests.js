...
angular.module('canteenApp')
  .controller('ReportsWorkersGuestsCtrl', function ($rootScope,$filter, roleService, $location, $scope, $http, APP_CONFIG,toastr, utility,ngProgressFactory,ngTableParams) {
    var vm = this;
    ...
    vm.GetOrdersWorkersGuests = function(){
