 ...
 */
    ...
    ReportsRealizedRequestedCtrl.$inject = ['$rootScope', '$filter', 'roleService', '$location', '$scope', '$http', 'APP_CONFIG', 'toastr', 'utility', 'ngProgressFactory', 'ngTableParams'];

    function ReportsRealizedRequestedCtrl($rootScope, $filter, roleService, $location, $scope, $http, APP_CONFIG, toastr, utility, ngProgressFactory, ngTableParams) {
        var vm = this;
